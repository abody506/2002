...
function localAI(input) {
  var t = norm(input);
  if (has(t, ['مرحبا','هلا','السلام عليكم','اهلا','صباح الخير','مساء الخير','هاي','hello','hi','مرحبتين','هلو'])) {
    var g = ['وعليكم السلام ورحمة الله وبركاته، حياك الله! تفضل بسؤالك.','هلا والله! كيف أقدر أساعدك اليوم؟','أهلاً بك! أنا هنا لأجاوب على أي سؤال عن الكلية التطبيقية.'];
  ...
  if (has(t, ['تدريب ميداني','تدريب عملي','internship','هل في تدريب','يوجد تدريب'])) return 'أكيد! التدريب الميداني من أهم مميزات الكلية. أغلب البرامج تتطلب تدريباً في جهة عمل حقيقية قبل التخرج.';
...
function matchSpec(t) {
  ...
  if (has(t, ['امن سيبراني','سيبراني','cybersecurity','امن المعلومات','حماية الشبكات'])) return 'تخصص الأمن السيبراني: حماية الأنظمة والشبكات من الهجمات. من أكثر التخصصات طلباً في سوق العمل.';
  ...
  if (has(t, ['حوسبه سحابيه','حوسبة سحابية','cloud computing','aws','azure'])) return 'تخصص الحوسبة السحابية: إدارة وتخزين البيانات عبر الخوادم السحابية. من أعلى التخصصات رواتباً.';
  if (has(t, ['تصميم نظم','تحليل نظم','systems analysis'])) return 'تخصص تصميم وتحليل النظم: دراسة احتياجات المؤسسات وتصميم أنظمة تقنية مناسبة.';
  ...
  if (has(t, ['دعم فني','it support','صيانة اجهزه','تقنية معلومات','تكنيشن'])) return 'تخصص الدعم الفني: تقديم المساندة التقنية وصيانة الأجهزة والشبكات. فرص عمل واسعة في جميع القطاعات.';
...
function matchAllSpecs(t) {
  if (has(t, ['كل التخصصات','جميع التخصصات','قائمة التخصصات','ايش في الكليه','وش في الكليه','كم تخصص','عدد التخصصات','التخصصات المتاحه','التخصصات المتوفره','اعرض التخصصات','ما هي التخصصات','اذكر التخصصات']) || (has(t, ['تخصصات']) && has(t, ['كل','جميع','قائمه','كم','عدد','ايش','وش','ما هي']))) {
    return 'الكلية تقدم 22 تخصصاً في 4 مجالات:\n\nالتقنية: الجرافيكس، الأمن السيبراني، البرمجة، تطوير الويب، UI/UX، الحوسبة السحابية، تصميم النظم، أنظمة المؤسسة، الدعم الفني.\n\nالصحية: مساعد طبيب أسنان، محضّرو المختبرات، فني رعاية مرضى، التعقيم الطبي.\n\nالإدارية: المحاسبة، التسويق والمبيعات، التسويق الرقمي، سلاسل الإمداد، خدمة العملاء، إدارة الفعاليات.\n\nالمتنوعة: الطاقة الشمسية، السلامة الصناعية، تعليم اللغة العربية.';
  }
  return null;
}
...
function localSmartAI(input) {
  ...
  if (has(t, ['تخصص','تخصصات','برنامج','برامج','دبلوم'])) return 'الكلية تقدم 22 تخصصاً متنوعاً. هل تريد معرفة تخصص معين؟ مثل: الجرافيكس، الأمن السيبراني، البرمجة، المحاسبة، الصحة، وغيرها.';
