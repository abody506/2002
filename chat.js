...
// OpenRouter AI - Free Model: google/gemma-4-31b-it:free
...
module.exports = async function handler(req, res) {
  ...
  const systemPrompt = [
    ...
    '- تنوع في اسلوب الرد',
    '- اذا سلم عليك قل وعليكم السلام ورحمة الله وبركاته حياك الله',
    ...
    'التخصصات التقنية: الجرافيكس والامن السيبراني والبرمجة وتطوير الويب وUI/UX والحوسبة السحابية وتصميم النظم وانظمة المؤسسة والدعم الفني',
    'التخصصات الصحية: مساعد طبيب اسنان ومحضرو المختبرات وفني رعاية مرضى والتعقيم الطبي',
    'التخصصات الادارية: المحاسبة والتسويق والمبيعات والتسويق الرقمي وسلاسل الامداد وخدمة العملاء وادارة الفعاليات',
    'التخصصات المتنوعة: الطاقة الشمسية والسلامة الصناعية وتعليم اللغة العربية للناطقين بغيرها'
  ].join('\n');
